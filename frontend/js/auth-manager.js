...
class AuthManager {
    ...
    updateAuthUI() {
        ...
        if (this.isAuthenticated) {
            ...
            // Hide premium badge
            this.hidePremiumBadge();
        }
    }

    /**
     * Update premium badge in top menu
     */
    updatePremiumBadge() {
        ...
        if (this.isPremium) {
            badgeContainer.innerHTML = `
                <div class="inline-flex items-center px-2 py-1 rounded-full bg-gradient-to-r from-canvas-accent to-canvas-accent2 text-white text-xs font-semibold">
    ...
    renderHeroCTAs() {
        ...
        if (tier === 'guest') {
            ...
            // Premium: Hide hero CTA container for premium users
            html = '';
        }
    ...
    setupEventListeners() {
        ...
        if (accountBtn) {
            accountBtn.addEventListener('click', () => {
                ...
                if (window.accountSettings) {
                    window.accountSettings.open();
                }
            });
        }
